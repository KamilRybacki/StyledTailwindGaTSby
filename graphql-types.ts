...
export type FileFieldsEnum =
  ...
  | 'childrenMdx___frontmatter___thumbnail'
  | 'childrenMdx___slug'
  | 'childrenMdx___body'
...
export type PostsThumbnailQueryVariables = Exact<{ [key: string]: never; }>;


export type PostsThumbnailQuery = { allFile: { edges: Array<{ node: { publicURL?: string | null } }> } };

export type PostsQueryVariables = Exact<{ [key: string]: never; }>;


export type PostsQuery = { allMdx: { nodes: Array<{ id: string, excerpt: string, slug?: string | null, frontmatter?: { title: string, date?: any | null, thumbnail?: string | null } | null }> } };
